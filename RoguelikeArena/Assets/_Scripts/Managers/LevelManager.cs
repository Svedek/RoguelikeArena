...
public class LevelManager : MonoBehaviour {
    ...
    private Room startRoom, exitRoom, shopRoom; // ?
    private int roomCount; // ?

    void Awake() {
        InitiateArena(160,1f);
    }
